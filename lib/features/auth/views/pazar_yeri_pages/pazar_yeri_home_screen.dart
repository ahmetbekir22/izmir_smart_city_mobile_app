...
class PazarYeriHomeScreen extends BaseListPage<Onemliyer> {
  PazarYeriHomeScreen()
      : super(
          title: 'Semt Pazarları',
          items: Get.put(PazarYeriController()).pazarYerleri,
          extractIlce: (pazarYeri) => pazarYeri.iLCE ?? '',
          extractMahalle: (pazarYeri) => pazarYeri.mAHALLE ?? '',
          extractAdi: (pazarYeri) => pazarYeri.aDI,
          extractEnlem: (pazarYeri) => pazarYeri.eNLEM,
          extractBoylam: (pazarYeri) => pazarYeri.bOYLAM,
          extractGun: (pazarYeri) => Get.put(PazarYeriController()).extractDay(pazarYeri.aCIKLAMA),
        );
}
